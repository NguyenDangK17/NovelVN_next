...
const Footer = () => {
  return (
    <footer className="bg-[#2c2c2c] text-white mx-auto flex flex-col items-center justify-center w-full">
      <div className="flex lg:flex-row flex-col items-center justify-between py-4 w-[75%] mx-auto">
      ...
      <div className="w-[75%] border-t border-t-solid px-10 py-4 lg:text-lg text-sm font-extralight">
        © 2025 MangaVN. All rights reserved.
      </div>
    </footer>
  );
};
