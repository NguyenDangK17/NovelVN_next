...
const teamMembers = [
  {
    ...
    image: 'https://i.pinimg.com/736x/c4/14/27/c4142714e3d7023b30965b445bb5fb6d.jpg',
  },
  {
    id: 2,
    name: 'Jane Smith',
      ...
      <div className="max-w-full mx-auto px-4 lg:px-12">
        ...
        <div className="relative h-[300px] md:h-[400px] rounded-lg overflow-hidden mb-12">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-black/80 to-black/40 flex items-center">
            <div className="p-8">
              <h1 className="text-4xl md:text-5xl font-bold mb-4">About MangaVN</h1>
              <p className="text-xl text-gray-300 max-w-2xl">
                Your ultimate destination for manga and novel discussions, reviews, and community.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              <p className="text-gray-300 text-lg leading-relaxed">
                At MangaVN, we&apos;re passionate about bringing manga and novel enthusiasts
                together. Our platform serves as a hub for discussions, reviews, and
                recommendations, fostering a vibrant community of readers and fans.
              </p>
              <p className="text-gray-300 text-lg leading-relaxed mt-4">
                We believe in the power of storytelling and aim to connect people through their
                shared love for manga and novels. Our goal is to create an inclusive space where
                everyone can discover new stories and connect with fellow enthusiasts.
              </p>
            </div>
        ...
        <div className="mb-12">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {teamMembers.map(member => (
              <div key={member.id} className="bg-[#2c2c2c] rounded-lg overflow-hidden">
        ...
        <div className="bg-[#2c2c2c] rounded-lg p-8 mb-12">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            ...
            <div>
              <div className="text-4xl font-bold text-primary-500 mb-2">3K+</div>
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">123 Manga Street, Novel City, 12345</p>
                  </div>
                </div>
                <div className="flex items-start">
              ...
              <div className="mt-6">
                ...
                <div className="flex space-x-4">
                  <Link href="#" className="text-gray-400 hover:text-primary-500 text-2xl">
                    <FaFacebook />
                  </Link>
                  <Link href="#" className="text-gray-400 hover:text-primary-500 text-2xl">
                    <FaTwitter />
